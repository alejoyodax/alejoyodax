...
![alt text](https://github.com/alejoyodax/alejoyodax/blob/main/tecnolog%C3%ADas.gif "Mis Tecnologías")
...
Actualmente laboro de tiempo parcial como **Administrador de Sistemas** en una IPS de Salud y curso en udemy **"React Pro: Lleva tus bases al siguiente nivel"** realizo proyectos web usando React y otras librerías de diseño en el Front-end. También realizo pequeños pasatiempos como el juego de ahorcado hecho con la librería React y la otra versión usando solo HTML, CSS y JavaScript PURO! o el famoso Tic-Tac-Toe hecho en python con la interfaz gráfica tkinter.
